...
such operators and any precedence between and including `^` and `<-` can be chosen. 
See examples below:
...
Piping with another precedence is useful when working interractively to avoid
editing brackets in many places. A common usecase is to avoid brackets
...
start of the expression as above, or in its binary form anywhere else outside of
...
To define a dubious syntax in your package should import *doubt* and reexport \code{doubt::`?`}. 
